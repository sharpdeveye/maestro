...
export function StarButton({
  ...
  return (
    <button
      ...
      ref={pathRef}
      className={cn(
        "relative z-[3] overflow-hidden inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-2xl text-[10px] font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50 group/star-button",
        className,
      )}
      {...props}
    >
      ...
      <span className="z-10 relative text-muted-foreground group-hover/star-button:text-foreground transition-colors">
        {children}
      </span>
    </button>
  );
